describe('Draggable.js', function() {
  ...
  describe('when dragging an element to a new position', function() {
    ...
    it('should update the element\'s position while within an absolute element', function() {
      ...
      var actualPosition = $(draggableBox).position();
      expect(actualPosition.top).to.be(320);
      expect(actualPosition.left).to.be(410);
    });
